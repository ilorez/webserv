...
[ ] link between CGI and request and response
    [ ] check is CGI working correctly for just run cgi
    [ ] for upload cgi and delete cgi its normal request that can be handeled by response
    [ ] test CGI basic requests get
